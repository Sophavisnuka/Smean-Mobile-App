...
/// Animated home icon inspired by ItsHover; wiggles subtly when active.
class ItshoverHomeIcon extends StatefulWidget {
  const ItshoverHomeIcon({
    super.key,
    this.size,
    this.color,
    this.animate = false,
  ...
  @override
  State<ItshoverHomeIcon> createState() => _ItshoverHomeIconState();
}

class _ItshoverHomeIconState extends State<ItshoverHomeIcon>
  ...
  @override
  void didUpdateWidget(covariant ItshoverHomeIcon oldWidget) {
