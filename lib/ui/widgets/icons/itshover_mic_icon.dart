...
/// Animated mic icon inspired by ItsHover; gentle wobble when active.
class ItshoverMicIcon extends StatefulWidget {
  const ItshoverMicIcon({
    super.key,
    this.size,
    this.color,
    this.animate = false,
  ...
  @override
  State<ItshoverMicIcon> createState() => _ItshoverMicIconState();
}

class _ItshoverMicIconState extends State<ItshoverMicIcon>
  ...
  @override
  void didUpdateWidget(covariant ItshoverMicIcon oldWidget) {
